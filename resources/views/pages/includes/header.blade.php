				...
				<ul class="nav user-menu">
					...
					<li class="nav-item dropdown has-arrow main-drop">
						...
						<div class="dropdown-menu">
							<a class="dropdown-item" href="{{route('aprofile')}}">My Profile</a>
                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
                            ...
                            <li class=""> 
								<a href="{{route('index')}}"><i class="la la-home"></i> <span>Dashboard</span></a>
							</li>
							<li class=""> 
								<a href="{{route('clients')}}"><i class="la la-users"></i> <span>Clients</span></a>
							</li>
                            <li class=""> 
								<a href="{{route('vendors')}}"><i class="la la-users"></i> <span>Vendors</span></a>
							</li>
                            <!-- <li class=""> 
								<a href="{{route('projects')}}"><i class="la la-rocket"></i> <span>Projects</span></a>
							</li> -->
                            <li class=""> 
								<a href="{{route('tasks')}}"><i class="la la-edit"></i> <span>Tasks</span></a>
							</li>
                            <li class=""> 
								<a href="{{route('employees')}}"><i class="la la-user"></i> <span>Employee</span></a>
							</li>
							<li class=""> 
								<a href="{{route('reports')}}"><i class="la la-pie-chart"></i> <span>Task Report</span></a>
							</li>
						</ul>
					</div>
                </div>
